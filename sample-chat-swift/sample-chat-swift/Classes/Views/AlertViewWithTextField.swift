...
class AlertViewWithTextField: NSObject, UIAlertViewDelegate {
     ...
     */
    init(_ title: String?,  message: String?, showOver: UIViewController!, didClickOk closureOk:@escaping (_ text : String?) -> Void, didClickCancel closureCancel:@escaping () -> Void) {
